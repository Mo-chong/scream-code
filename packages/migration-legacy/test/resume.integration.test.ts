 ...
 *     all from `@scream-code/agent-core/session/store`.
 *   - `Session` (constructor + `resume()` + `agents` map), from
 *     `@scream-code/agent-core`; `localJian` from `@scream-code/jian`. After
...
import {
  ...
  encodeWorkDirKey,
  normalizeWorkDir,
} from '@scream-code/agent-core/session/store';
import { Session, type SDKSessionRPC } from '@scream-code/agent-core';
